...
export default function VolkornesPage() {
  return (
    <div className="p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold tracking-tight mb-2">Élevage de Volkornes</h1>
        <p className="text-zinc-500 dark:text-zinc-400">
          Gérez votre élevage de Volkornes : captures, accouplements, et inventaire.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-4 mt-12 bg-white dark:bg-zinc-900/40 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm">
         ...
         <GenerationTree mounts={volkornes} />
      </div>
    </div>
  );
}
